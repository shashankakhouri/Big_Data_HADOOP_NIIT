...
REGISTER '/home/hduser/bigdata/externaljars/piggybank-0.13.0.jar'; --Register external jar 'Piggy Bank.jar'
REGISTER '/home/hduser/bigdata/externaljars/piggybank-0.13.0.jar'; --Register external jar 'Piggy Bank.jar'
DEFINE CSVExcelStorage org.apache.pig.piggybank.storage.CSVExcelStorage;  -- within the jar define a function CSVExcelStorage()  
data = LOAD '/home/hduser/DatasetsandCodes/h1b.csv' USING CSVExcelStorage() as 
(s_no:int,
...
store finaloutput into '/home/hduser/Pig/question10' using PigStorage('\t');
